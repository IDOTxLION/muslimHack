...
function ProgressBar(t0) {
    ...
    if ($[0] !== "0853c217e00943cc0ac2fd597b49407591ba694a420369d5c7657bb33728ba66") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0853c217e00943cc0ac2fd597b49407591ba694a420369d5c7657bb33728ba66";
    }
...
function LandingPage(t0) {
    ...
    if ($[1] !== auth) {
        t1 = ({
            "LandingPage[handleListBusiness]": ()=>{
                if (!auth) {
                    window.location.href = "/signup?role=business";
                    return;
                }
                if (auth.dashboardPath === "/dashboard/business") {
                    window.location.href = auth.dashboardPath;
                    return;
                }
    ...
    let t57;
    if ($[75] !== t13 || $[76] !== t24 || $[77] !== t36 || $[78] !== t42 || $[79] !== t51) {
...
_s(LandingPage, "3XKelCGcXa0C9ItEjvtOgicwMTw=");
_c2 = LandingPage;
...
//# sourceMappingURL=_07cnbya._.js.map