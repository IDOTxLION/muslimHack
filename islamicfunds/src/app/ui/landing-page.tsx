      ...
      <header style={{ backgroundColor: '#123E3A', position: 'sticky', top: 0, zIndex: 50 }}>
        <nav className="max-w-6xl mx-auto px-6 flex items-center justify-between" style={{ height: 64 }}>
          ...
          <div className="hidden md:flex items-center gap-3">
            {auth ? (
              <>
                <span style={{ color: '#DDE8E2', fontSize: 14, fontWeight: 500 }}>Hi, {auth.name}</span>
                <a
        ...
        {mobileOpen && (
          <div className="md:hidden px-6 pb-4 flex flex-col gap-3" style={{ backgroundColor: '#0e322f' }}>
            ...
            {auth ? (
              <a href={auth.dashboardPath} style={{ backgroundColor: '#D86F52', color: 'white', fontSize: 14, fontWeight: 600, padding: '10px 18px', borderRadius: 10, textDecoration: 'none', textAlign: 'center', marginTop: 8 }}>
                Go to Dashboard
              </a>
            ) : (
              <a href="/signup" style={{ backgroundColor: '#D86F52', color: 'white', fontSize: 14, fontWeight: 600, padding: '10px 18px', borderRadius: 10, textDecoration: 'none', textAlign: 'center', marginTop: 8 }}>
                Get Started
              </a>
            )}
          </div>
